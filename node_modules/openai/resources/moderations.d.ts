...
export declare namespace Moderations {
    type Moderation = ModerationsAPI.Moderation;
    type ModerationCreateResponse = ModerationsAPI.ModerationCreateResponse;
    type ModerationCreateParams = ModerationsAPI.ModerationCreateParams;
}
