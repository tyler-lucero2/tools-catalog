...
export declare namespace FineTunes {
    type FineTune = FineTunesAPI.FineTune;
    type FineTuneEvent = FineTunesAPI.FineTuneEvent;
    type FineTuneEventsListResponse = FineTunesAPI.FineTuneEventsListResponse;
    export import FineTunesPage = FineTunesAPI.FineTunesPage;
    type FineTuneCreateParams = FineTunesAPI.FineTuneCreateParams;
    type FineTuneListEventsParams = FineTunesAPI.FineTuneListEventsParams;
    type FineTuneListEventsParamsNonStreaming = FineTunesAPI.FineTuneListEventsParamsNonStreaming;
    type FineTuneListEventsParamsStreaming = FineTunesAPI.FineTuneListEventsParamsStreaming;
}
