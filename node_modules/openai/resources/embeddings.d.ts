...
export declare namespace Embeddings {
    type CreateEmbeddingResponse = EmbeddingsAPI.CreateEmbeddingResponse;
    type Embedding = EmbeddingsAPI.Embedding;
    type EmbeddingCreateParams = EmbeddingsAPI.EmbeddingCreateParams;
}
